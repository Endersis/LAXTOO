...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $contenido .= "<p>Presiona aquí: <a href='http://". $_SERVER["HTTP_HOST"] . "'>Confirmar Cuenta</a>";        
    ...
    public function enviarInstrucciones() {
        ...
        $contenido .= "<p>Presiona aquí: <a href='http://". $_SERVER["HTTP_HOST"] . "'>Reestablecer Password</a>";        
        $contenido .= "<p>Si tu no solicitaste este cambio, puedes ignorar el mensaje</p>";
        $contenido .= '</html>';
        $mail->Body = $contenido;
